...
- the orchestration of an export run ja
(how it is triggered, polled, transported);
...
| Action | Reversible from the exported value alone? | How the original is obtained |
| --- | --- | --- |
